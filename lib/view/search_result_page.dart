    ...
    if (viewModel.loading) {
      ...
      return Column(
        children: [
          ...
          Container(
            child: viewModel.bookList.isEmpty
                ? Container()
                : ListView.builder(
                    shrinkWrap: true,
                    primary: false,
                    // physics: NeverScrollableScrollPhysics(),
                    itemCount: viewModel.chunkedList.isEmpty
                        ? 0
                        : viewModel.chunkedList.length,
                    itemBuilder: (context, index) => Container(
                      child: BookWidget(
                        ...
                        onPressedAction: () async {
                          await viewModel
                              .favButtonAction(viewModel.bookList[index]);
                        },
                      ),
                    ),
                  ),
          ...
          Visibility(
            ...
            child: Container(
              ...
              child: viewModel.loadingNewData
